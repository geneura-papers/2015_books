...
%más de la cuenta) hacer una resumen de lo hecho y decir el
...
\begin{figure}[!h] 
\begin{center}
  \epsfig{file=som43.eps,width=\textwidth}
\caption{\small{Análisis de los datos iniciales, usando 43 variables
    descriptivas por libro, utilizando el SOM.}}
% Además, no es un análisis, es una evolución temporal de un solo
% entrenamiento.  - JJ
\label{fig:som43}
\end{center}
\end{figure}
...
\begin{figure}[!h] 
\begin{center}
  \epsfig{file=som13.eps,width=\textwidth}
