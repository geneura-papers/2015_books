...
In this section we show the output of one of the models built during the regression, namely we present two of the decision trees generated by M5P method applied to the data of the publisher that sells the most. These aim to demonstrate the value of the proposal to generate a useful decision-aid tool for an expert (publisher) to determine what sales can be expected for the different values of the input variables (including the print-run).  
