...
% It's not proposed. It just obtained the best result with WEKA. 
...
\end{tabular}
\caption{\small{Initial data analysis, using 43 descriptive variables per bok, using SOM.}}
...
\caption{Variables that describe every book, 13 in total, after the
  ...
  experienced manager % él no hizo el análisis. No cuela con ``along
                      % with'' - JJ
