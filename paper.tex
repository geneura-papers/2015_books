...
For this reason, 
%have been used in this work: BestFirst, that searches the space of feature subsets by greedy hill-climbing augmented with a backtracking facility, and Ranker, that ranks features by their individual evaluations.
\end{itemize}
