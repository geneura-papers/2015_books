...
\begin{figure}[!ht] 
\begin{center}
  \epsfig{file=SOM_25x16_pre_venta.eps,width=15cm}
\caption{\small{SOM analysis.}}
\label{fig:somanalysis}
\end{center}
\end{figure}

\begin{figure}[!ht] 
\begin{center}
  \epsfig{file=UMATRIX_25x16_pre_venta.eps,width=15cm}
\caption{\small{SOM UMATRIX.}}
\label{fig:somumatrix}
\end{center}
\end{figure}

After the SOM analysis (see Figures \ref{fig:somanalysis} and \ref{fig:somumatrix}), the following variables have been selected: 
