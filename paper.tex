...
There are several difficulties inherent to the new book sales forecasting, such as dealing with limited data, finding adequate forecasting methods, and selecting the best method to use.
...
Sin embargo, en el caso de nuevos libros no hay datos históricos que ayuden a definir patrones, y sólo ciertos datos descriptivos están disponibles. 
...
Así pues, en esta investigación se propusieron para su evaluación los siguientes métodos:
...
\begin{itemize}
 ...
 \item Support Vector Machine for Regression (SMOreg)

 % weka.classifiers.lazy.IBk 
 %		http://weka.sourceforge.net/doc.dev/weka/classifiers/lazy/IBk.html
 \item K-nearest neighbours classifier (IBk)
