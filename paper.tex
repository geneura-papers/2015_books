...
initial exploratory analysis phase using visualisation techniques, we have
...
then used machine learning to create a model and forecast sales. The
initial methodology was used in a commercial product by Grupo
Trevenque, but the methodology described here improves the forecasting running time  %with
                                %respect to what?- JJ
and is
eventually able to predict sales from pre-publication data with
remarkable accuracy, thus creating a useful tool for publishers, for whom
% Moreover,
...
obtained models provide a reliable guidance on the decision process of
...
distribution and storage processes.  When a company is faced with the problem or
