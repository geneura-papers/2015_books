...
%%%%%%%%%%%%%%%% Titulo %%%%%%%%%%%%%%%
\title{Enhancing the prediction of sales for newly published books by means of computational intelligence methods} 
...
For SVM, the widely used Radial Basis Function (RBF) kernel is selected. As reported in several studies, RBF kernel has a reliable performance and can analyse higher dimensional data \cite{yu2004ec,chao2015construction,huang2006ga}. Two important
...
meta-algorithms \cite{Cheng2006_tunningSVM,Lessmann2011_tunningDM},  
% Antonio - add an ESWA reference to this. :D
% Antonio - I have done it.
for instance. 
