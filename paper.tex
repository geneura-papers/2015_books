...
The objective is to offer a tool for publishers which will aid them to decide the best print run for a new book before its publication process starts. This is a forecasting problem for which no specific historical data are available, since the same book has not been previously published.
