...
\ref{tabla:results9} and \ref{tabla:results4}, using those categorical variables 
as part of a big data set makes the problem hard to solve, both in required 
time to build the forecasting models as well as in the obtained errors.
