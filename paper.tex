...
\label{sec:soa}
% Antonio - TODO: Since two new sections have been added here, maybe we should change the title of the section... Maybe 'Background and related works'?
% I don't see how or what the new title might change ....  ???   we can discuss this item later this morning.
...
% Antonio - TODO: link this section with the rest of the SotA. Introduce it in a paragraph before.
...
evaluation criteria, commonly used in the bibliography that have been chosen 
...
% Antonio - TODO: The next paragraph is referring to Section 2.1. We must change it.
% Why? anyway, I add "As stated before,"
As stated before, in Section \ref{subsec:select_method} a selection of the best 
forecasting techniques that have been conducted has been reported, looking for 
those rule- or tree-based, together with numerical methods which could yield 
the best results. 
