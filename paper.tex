...
Moreover, the initial set of features in the dataset must be revised in order to consider just those that can be known before the launch of the book, i.e. those whose value do not depend on the book sales. So, we have selected the subset of features described in Table \ref{tabla:params_pre_sales}.
