...
them are categorical, which makes them harder to process, even more so if the number of categories is high. As stated in those works, given these issues, finding adequate forecasting techniques and selecting the best method to use is also a problem.
...
% We can remove this sentence if you think it only should appear together with a reference...
 They analyse data about sales and, taking into account their knowledge of industry, their experience, and their perception about trends, could make decisions on the companies production, i.e. how many books should be printed when a new book is published. 
