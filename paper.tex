...
\begin{table}
\caption{Considered pre-sales features and their types. It also shows the names of the variables used in the applied methods.}
\label{tabla:params_pre_sales}
\begin{center}
\begin{tabular}{|c|l|l|c|c|}
\hline 
No. & Feature Name & Variable & Type & Input/Output\\
\hline 
...
Once a dataset has been composed it must be preprocessed, i.e. it should be revised in order to fix the existing errors (such as wrong or duplicated patterns), or to complete (or address) the absence of information, for instance. The aim is looking for the correctness, homogeneity and completeness of the data.
