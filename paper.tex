...
In general, historical data are used to make time series, and extracting common patterns and obtaining accurate predictions from them.
...
\caption{Considered pre-sales features and their types. The third column shows
  the names of the variables used in the applied methods, and the last one indicates if it has been used as an input (independent) or an output (dependent) variable.} 
