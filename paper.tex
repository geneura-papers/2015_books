...
Sin embargo, en el caso de nuevos libros no hay datos históricos que ayuden a definir patrones, y sólo ciertos datos descriptivos están disponibles, por lo que no todos los métodos de predicción se pueden utilizar \cite{Madsen2008}. 
