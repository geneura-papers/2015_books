...
In the first experiment, forecasting methods have been applied to the whole dataset. All the pre-sales features have been considered. Obtained results are presented in Table \ref{tab:all_editors_no_fs}.
...
\hline 
K-NN & 0.787 $\pm$ 0.08 & 272.294 $\pm$ 32.38 & 840.594 $\pm$ 240.11 & 47.475 $\pm$ 3.39 & 63.072 $\pm$ 10.29 & 0.001 $\pm$ 0.01\tabularnewline
\hline
M5P & 0.890 $\pm$ 0.09 & 214.365 $\pm$ 22.96 & 634.229 $\pm$ 307.76 & 37.457 $\pm$ 3.12 & 48.324 $\pm$ 25.16 & 18.845 $\pm$ 0.61\tabularnewline
\hline 
Random Forest & 0.840 $\pm$ 0.05 & 253.365 $\pm$ 29.43 & 788.937 $\pm$ 282.01 & 44.164 $\pm$ 2.76 & 57.766 $\pm$ 8.15 & 4.906 $\pm$ 0.12\tabularnewline
\hline 
Linear Regression & 0.872 $\pm$ 0.07 & 308.679 $\pm$ 25.44 & 680.905 $\pm$ 226.41 & 54.053 $\pm$ 4.38 & 52.130 $\pm$ 18.29 & 984.687 $\pm$ 128.21\tabularnewline
\hline 
SVM & 0.876 $\pm$ 0.04 & 248.763 $\pm$ 27.49 & 732.641 $\pm$ 260.56 & 43.371 $\pm$ 2.35 & 53.471 $\pm$ 6.29 & 6169.239 $\pm$ 281.49\tabularnewline
\hline 
\end{tabular}
\end{table}

***TODO***: the results show...
...
The selected features per method are shown in Table \ref{tab:features_selected}.

\begin{table}
\caption{Features selected by each method 
\label{tab:features_selected}}
\centering{}%
\begin{tabular}{|c|c|c|c|c|}
\hline 
No. & Feature & ReliefFAttributeEva & CfsSubsetEval & SOM\tabularnewline
\hline 
1 & ret\_price & $\checkmark$ &  & $\checkmark$\tabularnewline
\hline 
2 & subject1 & $\checkmark$ & $\checkmark$ & $\checkmark$\tabularnewline
\hline 
3 &  Editorial+Collection &  &  & \tabularnewline
\hline 
4 & binding &  &  & \tabularnewline
\hline 
5 & gifts & $\checkmark$ &  & $\checkmark$\tabularnewline
\hline 
6 & distrib\_novelty & $\checkmark$ &  & \tabularnewline
\hline 
7 & tot\_points\_sale & $\checkmark$ &  & $\checkmark$\tabularnewline
\hline 
8 & tot\_points\_sale\_1st\_year & $\checkmark$ &  & \tabularnewline
\hline 
9 & weeks\_sale & $\checkmark$ &  & $\checkmark$\tabularnewline
\hline 
10 & print\_run & $\checkmark$ & $\checkmark$ & $\checkmark$\tabularnewline
\hline 
\end{tabular}
\end{table}

% Antonio - TODO: change the names (and font format) to the same as variables in previous tables



*************** TO CHANGE WITH THE NEW RESULTS **************
