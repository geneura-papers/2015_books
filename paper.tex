...
forecasting is proposed to solve three real-world sales forecasting problems, namely: new tea, cosmetics, and soft drink products. In that study, products are classified based on their sales patterns, so it is assumed that products in the same class would follow a similar sales pattern. 
...
forecasting methods have beeen applied, such as in \cite{Chang2009}, 
