...
\begin{figure*}[ht]
\begin{center}
\includegraphics[scale=0.35]{./imgs/prediction_all_publisher_all_features_Table3.eps}
\end{center}
\caption{Predicting \texttt{total\_sales} for all publishers (all the features). 30 repetitions, 10-fold cross validation.}
...
\begin{figure*}[ht]
\begin{center}
\includegraphics[scale=0.25]{som_planes.eps}
\end{center}
...
\begin{figure*}[ht]
\begin{center}
\includegraphics[scale=0.35]{./imgs/prediction_all_publisher_Table5.eps}
\end{center}
\caption{Predicting \texttt{total\_sales} for all publishers based on features selected by each method.}
...
\begin{figure*}[ht]
\begin{center}
\includegraphics[scale=0.55]{./imgs/attribute_All.eps}
\end{center}
\caption{Predicting \texttt{total\_sales} for publishing companies UDL929 (the best selling publishing company), UDLW12 (the median selling publishing company), UDL704 (highest number of different titles sold) and UDLU11 (medium number of different books sold).}
...
%--------------- old Tables 7, 8, 9, 10 (before revision)
...
%--------------- old Tables 11, 12, 13, 14 (before revision)
