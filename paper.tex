...
\ead{palomacd@ugr.es}
\author[ugr]{María I. García-Arenas}
\ead{mgarenas@ugr.es}
...
The University of Jordan, Amman, Jordan. Tel: +. Fax: +}
...
Therefore, after the data has been collected and initially preprocessed (as described in previous section), other preprocessing techniques are applied, such as Feature Selection (FS) \cite{kittler1986feature}, which is portrayed in Section \ref{subsec:data_preproces}. These methods check the relevance of all the variables of the patterns, aiming to reduce even more this set of features, in order to obtain intelligible models, in a lesser amount of time due to their lower complexity, and usually without accuracy loss.
...
closest $k$ vectors found in the training set by majority vote.
 ...
 \item \emph{Random Forest (RF)}: This method is based on the construction of a set of decision trees using a stochastic process over the basis of C4.5 algorithm. It was proposed by Breiman \cite{Breiman2001} and aims to create independent and uncorrelated trees based on different and random input vectors, following the same distribution.
...
In this paper, the problem of how many books should be printed when a new book is going to be published is faced using several data-mining and forecasting methods.
...
As a conclusion, M5P yields the best results overall, obtaining the best accuracy (lowest error) on average, even with acceptable values regarding the training time.
In addition, the Decision Trees obtained with this method have been presented as an excellent decision-aid tool for publishers, since they are accurate and quite easy to understand and apply. They are also able to provide insights on the decisions that have a higher influence on the print-run for these publishers. 
...
significantly, another way to improve sales predictions could be making a thorough study of the effect of the application of discounts and promotions. 

Finally, there are some variables over which the publisher has some
control once the book has been published, such as the initial print-run, the books offered as gifts to reviewers, or what proportion is going to be sent to each possible point of sale. These can be incorporated into an optimisation model that will optimise those values to obtain desired sales. 
...
\hline 
kNN & 78.2 $\pm$0.12 & 99.45 $\pm$24.31 & 170.83 $\pm$46.34 & 54.53 $\pm$12.28 & 65.86 $\pm$18.34 & 0.0001 $\pm$0.0003\tabularnewline
\hline 
...
\hline 
kNN & 85.8 $\pm$0.09 & 79.42 $\pm$21.47 & 140.95 $\pm$44.93 & 43.34 $\pm$10.07 & 53.31 $\pm$14.37 & 0.0001 $\pm$0.0002\tabularnewline
\hline 
...
\hline 
kNN & 64.8 $\pm$0.18 & 702.70 $\pm$181.41 & 1008.39 $\pm$305.87 & 71.41 $\pm$13.95 & 78.47 $\pm$22.70 & 0.0001 $\pm$0.0002\tabularnewline
\hline 
...
\hline 
kNN & 83.6 $\pm$0.10 & 492.18 $\pm$126.86 & 727.33 $\pm$209.88 & 50.12 $\pm$10.69 & 56.14 $\pm$12.89 & 0 $\pm$0.0002\tabularnewline
\hline 
...
\hline 
kNN & 85.3 $\pm$0.15& 825.19 $\pm$235.34 & 1280.33 $\pm$523.06 & 50.23 $\pm$14.07 & 51.42 $\pm$21.24 & 0.0001 $\pm$0.0002\tabularnewline
\hline 
...
\hline 
kNN & 89.0 $\pm$0.10 & 746.45 $\pm$250.76 & 1203.41 $\pm$564.84 & 44.36 $\pm$9.73 & 46.25 $\pm$14.41 & 0.0001 $\pm$0.0003\tabularnewline
\hline 
...
\hline 
kNN & 75.2 $\pm$0.27 & 15.73 $\pm$7.73 & 26.68 $\pm$14.82 & 48.58 $\pm$24.77 & 66.23 $\pm$48.59 & 0.0001 $\pm$0.0003\tabularnewline
\hline 
...
\hline 
kNN & 74.0 $\pm$0.29 & 15.93 $\pm$8.52 & 28.28 $\pm$16.28 & 48.83 $\pm$25.89 & 68.75 $\pm$48.85 & 0 $\pm$0.0002\tabularnewline
\hline 
