...
Well known forecasting methods implemented in the Weka\footnote{{\tt http://www.cs.waikato.ac.nz/ml/weka/}} tool \cite{Hall2009,Witten2011} have been choosen, as these methods are widely known, and could be very helpful for practitioners to reproduce experiments and even to solve similar sales prediction problems using these methods.
