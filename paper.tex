...
run can be made, resulting in temporary losses due to a lack of supply
or in bad marketing for the customers, for instance.   
...
depend on how many you have printed. Books then go, in some cases, to
the {\em novelty} table, that is, prominently displayed in the
bookstore, shown in the window, or highlighted using props or other
kind of advertisement. Books stay for sale for as long as the
publisher or the store want until the bookseller decides to return it
to the publisher or just, in some cases, move it away from shelves to
storage. Books returned to the publisher are pulped, sold back or
given to the author or distributed in second-hand channels such as
...
in the last few years since Amazon started to sell in Spain, which
...
Our intention in this paper is to find out the main factor influencing
sales in order to give a tool that the publisher can use to decide how
...
At this stage, a Feature Selection (FS) process has been carried out, since it is an effective dimensionality reduction technique and an essential preprocessing method to discard less relevant or non-useful features \cite{Krishnapuram2004,Chen2011_FS_PTS}.
...
is updated along with the neurons in its neighbourhood. This neuron is called the best matching unit (BMU). The goal of the learning process is to
...
We have analysed the whole dataset (all the publishing companies), but also performed some experiments considering specific and representative publishing companies as example cases.
Some of the obtained decision trees have been plotted to show their simplicity and to remark their real value as a decision-aid tool for publishers.
...
some parameters have a high influence on its performance. We have conducted a systematic experimentation process, along with a revision of the bibliography describing the best configuration parameters for the methods we have applied here. 

Thus, in our experiments, the best value of $k$ in the $k$-nearest neighbour was empirically found at $k=3$. % What???? - JJ
For SVM, the widely used Radial Basis Function (RBF) kernel is selected. As reported in several studies, RBF kernel has a reliable performance and can analyse higher dimensional data \cite{yu2004ec,chao2015construction}. Two important parameters should be tuned in SVM: the Cost $(C)$ and Gamma $(\gamma)$ of the RBF kernel. We apply grid search which is the most common approach
...
The selected features using each one of the three methods are shown in Table \ref{tab:features_selected}. Logically, just the independent or input variables are considered.
...
Table \ref{Table:special_cases} shows the number of sold copies and the number of titles published by the selected companies.
...
method showed in the previous experiment the highest predictive power among all classifiers. 
%According to the aforementioned tables, 
%It's not according to a table. It's according to the results there - JJ
RFE reduction has noticeably improved the performance of all classifiers specially in the case of the best selling publisher house (i.e. UDL929) and the
publisher which publishes a wide range of different books (i.e. UDL704). For the rest of the results which are obtained by CSE and SOM feature selection methods we refer the reader to the appendix of tables at the end of this paper.  
...
is similar such as novelty items or toys, and might be of interest to other academic researches and
...
methods, such as genetic programming or fuzzy logic. 
...
\bibitem{Fildes2010}
R.~Fildes, B.~Kingsman, {Incorporating demand uncertainty and forecast error in
  supply chain planning models}, J Oper Res Soc 62 (2010) 483--500.

\bibitem{Saeed2008}
K.~Saeed, {Trend forecasting for stability in supply chains}, J Bus Res 61
  (2008) 1113--1124.

\bibitem{Zhao2001}
X.~Zhao, J.~Xie, R.~Lau, {Improving the supply chain performance: use of
  forecasting models versus early order commitments}, Int J Prod Res 39~(17)
  (2001) 3923--3939.

\bibitem{Little1998}
J.~Little, {Integrated measures of sales, merchandising and distribution}, Int
  J Res Mark 15 (1998) 473--485.

\bibitem{Armstrong2001}
J.~Armstrong, {Principles of forecasting. A handbook for researchers and
  practitioners}, Kluwer, Norwell, 2001.

\bibitem{SThomassey2014}
S.~Thomassey, {Sales Forecasting in Apparel and Fashion Industry: A Review},
  Intell Fashion Forecasting Syst: Models and App (2014) 2--27.

\bibitem{DeToni2000}
A.~D. Toni, A.~Meneghetti, {The production planning process for a network of
  firms in the textile-apparel industry}, Int J Prod Econ 65 (2000) 17--32.

\bibitem{kohonen1998}
T.~Kohonen, {The self-organizing map}, Neurocomputing 21~(1-3) (1998) 1--6.

\bibitem{Chang2009}
P.~Chang, C.~Liu, C.~Fan, {Data clustering and fuzzy neural network for sales
  forecasting: A case study in printed circuit board industry}, Knowl Based
  Syst (2009) 344--355.

\bibitem{Sanders1994}
N.~Sanders, K.~Manrodt, {Forecasting practices in US corporations: Survey
  results}, Interfaces 24~(2) (1994) 92--100.

\bibitem{Papalexopoulos1990}
A.~Papalexopoulos, T.~Hesterberg, {A regression-based approach to short-term
  system load forecasting}, IEEE Trans Power Syst 5 (1990) 1535--1547.

\bibitem{Yoo1999}
H.~Yoo, R.~Pimmel, {Short-term load forecasting using a self-supervised
  adaptive neural network}, IEEE Trans Power Syst 14~(2) (1999) 779--784.

\bibitem{Mastorocostas2001}
P.~Mastorocostas, J.~Theocharis, V.~Petridis, {A constrained orthogonal
  least-squares method for generating TSK fuzzy models: application to
  short-term load forecasting}, Fuzzy Set Syst 118 (2001) 215--233.

\bibitem{Chu2003}
C.~Chu, P.~Zhang, {A comparative study of linear and nonlinear models for
  aggregate retail sales forecasting}, Int J Prod Econ 86 (2003) 217--231.

\bibitem{Brown1959}
R.~Brown, {Smoothing forecasting and prediction of discrete time series},
  Prentice Hall, Englewood Cliffs, 1959.

\bibitem{Winters1960}
P.~Winters, {Forecasting sales by exponential weighed moving averages}, Manag
  Sci 6 (1960) 324--342.

\bibitem{Box1969}
G.~Box, G.~Jenkins, {Time series analysis forecasting and control}, Prentice
  Hall, Englewood Cliffs, 1969.

\bibitem{KayacanUK10}
E.~Kayacan, B.~Ulutas, O.~Kaynak, Grey system theory-based models in time
  series prediction, Expert Syst Appl 37~(2) (2010) 1784--1789.

\bibitem{ChingChin2010}
C.~Ching-Chin, A.~I.~K. Ieng, W.~Ling-Ling, K.~Ling-Chieh, {Designing a
  decision-support system for new product sales forecasting}, Expert Syst Appl
  37~(2) (2010) 1654--1665.

\bibitem{FaderHardie2005}
S.~Fader, B.~Hardie, {The value of simple models in new product forecasting and
  customer-base analysis}, Appl Stoch Model Bus (2005) 461--473.

\bibitem{Madsen2008}
H.~Madsen, {Time series analysis}, Chapman and Hall. CRC Co., 2008.

\bibitem{Lapide1999}
L.~Lapide, {New developments in business forecasting}, J Bus Forecasting (1999)
  29--30.

\bibitem{ChernWSF15}
C.-C. Chern, C.-P. Wei, F.-Y. Shen, Y.-N. Fan, A sales forecasting model for
  consumer products based on the influence of online word-of-mouth., Inf Syst E
  Bus Manag 13 (2015) 445--473.

\bibitem{Moon2010ICSSSM}
G.~Moon, G.~Kikuta, T.~Yamada, A.~Yoshikawa, T.~Terano, {Blog information
  considered useful for book sales prediction}, in: 7th International
  Conference on Service Systems and Service Management (ICSSSM), IEEE. Tokyo,
  2010, pp. 1--5.

\bibitem{Moon2010ICEC}
G.~Moon, G.~Kikuta, T.~Yamada, A.~Yoshikawa, T.~Terano, Categorization of sales
  patterns to use blog information as book sales prediction, in: Proceedings of
  the 12th International Conference on Electronic Commerce: Roadmap for the
  Future of Electronic Business, ICEC '10, ACM, New York, NY, USA, 2010, pp.
  1--7.

\bibitem{Hammond1990}
J.~Hammond, {Quick response in apparel industries}, Havard Business school,
  Cambridge, 1990.

\bibitem{Xia2012}
M.~Xia, Y.~Zhang, L.~W.~S. Ye, {Fashion retailing forecasting based on extreme
  learning machine with adaptive metrics of inputs}, Knowl Based Syst 36 (2012)
  253--259.

\bibitem{Thomassey2012}
S.~Thomassey, {Sales forecasts in clothing industry. The key success factor of
  the supply chain management}, Int J Prod Econ 128 (2012) 470--483.

\bibitem{wiki:dewey}
Wikipedia,
  \href{\url{https://en.wikipedia.org/wiki/List_of_Dewey_Decimal_classes}}{List
  of dewey decimal classes}, [Online; accessed 05-May-2016].
\newline\urlprefix\url{\url{https://en.wikipedia.org/wiki/List_of_Dewey_Decimal_classes}}

\bibitem{fayyad1996data}
U.~Fayyad, G.~Piatetsky-Shapiro, P.~Smyth, From data mining to knowledge
  discovery in databases, AI magazine 17~(3) (1996) 37.

\bibitem{kittler1986feature}
J.~Kittler, Handbook of pattern recognition and image processing, Academic
  press, 1986.

\bibitem{Krishnapuram2004}
B.~Krishnapuram, A.~Hartemink, L.~Carin, M.~Figueiredo, {A Bayesian Approach to
  Joint Feature Selection and Classifier Design}, IEEE T Pattern Anal 26~(9)
  (2004) 1105--1111.

\bibitem{Chen2011_FS_PTS}
Y.~Chen, D.~Miao, R.~Wang, K.~Wu, A rough set approach to feature selection
  based on power set tree, Knowl Based Syst 24~(2) (2011) 275 -- 281.

\bibitem{Selvakuberan2008}
K.~Selvakuberan, M.~Indradevi, R.~Rajaram, {Combined Feature Selection and
  classification - A novel approach for the categorization of web pages}, J Inf
  Comp Sci 3~(2) (2008) 083--089.
...
\bibitem{Hall2009}
M.~Hall, E.~Frank, G.~Holmes, B.~Pfahringer, P.~Reutemann, I.~Witten, {The WEKA
  data mining software: an update}, ACM SIGKDD Explor Newslett 11~(1) (2009)
  10--18.

\bibitem{Witten2011}
I.~Witten, E.~Frank, M.~Hall, {Data mining: Practical machine learning tools
  and techniques}, Morgan Kaufmann, 2011.

\bibitem{Hall1998}
M.~A. Hall, Correlation-based feature subset selection for machine learning,
  Ph.D. thesis, University of Waikato, Hamilton, New Zealand (1998).

\bibitem{RobnikSikonja1997}
M.~Robnik-Sikonja, I.~Kononenko, An adaptation of relief for attribute
  estimation in regression, in: D.~H. Fisher (Ed.), Fourteenth International
  Conference on Machine Learning, Morgan Kaufmann, 1997, pp. 296--304.

\bibitem{Kira1992}
K.~Kira, L.~A. Rendell, {A Practical Approach to Feature Selection}, in: D.~H.
  Sleeman, P.~Edwards (Eds.), Ninth International Workshop on Machine Learning,
  Morgan Kaufmann, 1992, pp. 249--256.

\bibitem{UmatUlts}
S.~Ultsch, Kohonen's self-organizing maps for exploratory data analysis, in:
  Proc. of the INNC'90, 2000, pp. 305--308.

\bibitem{Quinlan1986}
J.~Quinlan, {Induction of decision trees}, Mach Learn 1 (1986) 181--186.

\bibitem{Quinlan1992}
R.~J. Quinlan, Learning with continuous classes, in: 5th Australian Joint
  Conference on Artificial Intelligence, World Scientific, Singapore, 1992, pp.
  343--348.

\bibitem{Wang1997}
Y.~Wang, I.~H. Witten,
  \href{https://www.researchgate.net/profile/Ian_Witten/publication/33051395_Induction_of_model_trees_for_predicting_continuous_classes/links/545948ea0cf2cf516483ce67.pdf}{Induction
  of model trees for predicting continuous classes}, Tech. rep., Dept. of
  Computer Science, University of Waikato, working Paper 96/23, Poster papers
  of the 9th European Conference on Machine Learning (1996).
\newline\urlprefix\url{https://www.researchgate.net/profile/Ian_Witten/publication/33051395_Induction_of_model_trees_for_predicting_continuous_classes/links/545948ea0cf2cf516483ce67.pdf}

\bibitem{WittenFrank2000}
I.~Witten, E.~Frank, {Data mining}, Morgan Kaufmann, 2000.

\bibitem{Solomatine2004}
D.~Solomatine, Y.~Xue, {M5 Model Trees and Neural Networks: Application to
  FloodForecasting in the Upper Reach of the Huai River in China}, J Hydrol Eng
  9~(6) (2004) 491--501.

\bibitem{Aha1991}
D.~Aha, D.~Kibler, Instance-based learning algorithms, Mach Learn 6 (1991)
  37--66.
...
\bibitem{Cohen2003}
J.~Cohen, P.~Cohen, S.~West, L.~Aiken, {Applied multiple regression/correlation
  analysis for the behavioral sciences}, Lawrence Erlbaum Associates, 2003.
...
\bibitem{Rencher2102}
A.~Rencher, W.~Christensen, {Multivariate regression}, Vol. 709 of Wiley Series
  in Probability and Statistics, John Wiley and Sons, 2012.

\bibitem{EnkeT05}
D.~Enke, S.~Thawornwong, The use of data mining and neural networks for
  forecasting stock market returns, Expert Syst Appl 29~(4) (2005) 927--940.

\bibitem{McClendon2015}
L.~McClendon, N.~Meghanathan, Using machine learning algorithms to analyze
  crime data, Mach Learn and App 2~(1).

\bibitem{Cortes1995}
C.~Cortes, V.~Vapnik, {Support Vector Networks}, Mach Learn 20 (1995) 273--297.

\bibitem{Shevade1999}
S.~Shevade, S.~Keerthi, C.~Bhattacharyya, K.~Murthy, Improvements to the smo
  algorithm for svm regression, IEEE T Neural Networ.

\bibitem{MinSVM05}
J.~H. Min, Y.~Lee, Bankruptcy prediction using support vector machine with
  optimal choice of kernel function parameters, Expert Syst. Appl. 28~(4)
  (2005) 603--614.

\bibitem{Cao2003}
L.~Cao, {Support vector machine experts for time series forcasting},
  Neurocomputing 51 (2003) 321--339.

\bibitem{Jari2008}
C.~Jari, L.~Wen, L.~Kang, {Support vector machine classification for large data
  set vis minmum enclosing ball clustering}, Neurocomputing 71 (2008) 611--619.

\bibitem{gepsoft}
{Gepsoft}, {Analyzing GeneXproTools Models Statistically. Statistical Analysis
  of Time Series Prediction Models}, {\tt
  http://www.gepsoft.com/gxpt4kb/Chapter10/Section3/Introduction.htm} (Dec.
  2015).

\bibitem{pentaho}
{pentaho}, {Pentaho Data Mining Community Documentation}, {\tt
  http://wiki.pentaho.com/display/DATAMINING} (Dec. 2015).

\bibitem{otexts}
{otexts}, {Forecasting: principles and practice. The forecaster's toolbox.
  Evaluating forecast accuracy}, {\tt https://www.otexts.org/fpp/2/5} (Dec.
  2015).

\bibitem{Hyndman2013}
R.~Hyndman, G.~Athanasopoulos, Forecasting: principles and practice, OTexts,
  2013.

\bibitem{yu2004ec}
X.~Yu, S.~Liong, V.~Babovic, Ec-svm approach for real-time hydrologic
  forecasting., J Hydroinform 6 (2004) 209--223.

\bibitem{chao2015construction}
C.-F. Chao, M.-H. Horng, The construction of support vector machine classifier
  using the firefly algorithm, Computat Intell Neurosci.
...
\bibitem{mirjalili2014let}
S.~Mirjalili, S.~M. Mirjalili, A.~Lewis, Let a biogeography-based optimizer
  train your multi-layer perceptron, Inform Sciences 269 (2014) 188--209.

\bibitem{wdaa2008differential}
A.~S.~I. Wdaa, Differential evolution for neural networks learning enhancement,
  Ph.D. thesis, Universiti Teknologi Malaysia (2008).

\bibitem{mirjalili2015effective}
S.~Mirjalili, \href{http://dx.doi.org/10.1007/s10489-014-0645-7}{How effective
  is the grey wolf optimizer in training multi-layer perceptrons}, Appl Intell
  43~(1) (2015) 150--161.
\newblock \href {http://dx.doi.org/10.1007/s10489-014-0645-7}
  {\path{doi:10.1007/s10489-014-0645-7}}.
\newline\urlprefix\url{http://dx.doi.org/10.1007/s10489-014-0645-7}
...
R.~Kohavi, A study of cross-validation and bootstrap for accuracy estimation
  ...
  Conference on Artificial Intelligence, {IJCAI} 95, Montr{\'{e}}al
  Qu{\'{e}}bec, Canada, August 20-25 1995, 2 Volumes, Morgan Kaufmann, 1995,
  pp. 1137--1145.

\bibitem{Devijver1982}
P.~Devijver, J.~Kittler, {Pattern Recognition: A Statistical Approach},
  Prentice-Hall, 1982.

\bibitem{POS}
M.~Gil, Puntos de venta de prensa y libros,
  \url{https://antinomiaslibro.wordpress.com/2013/11/21/puntos-de-venta/},
  consulted on May 21st, 2016 (November 2013).

\bibitem{huang2006ga}
C.-L. Huang, C.-J. Wang, A ga-based feature selection and parameters
  optimization for support vector machines, Expert Syst Appl 31~(2) (2006)
  231--240.

\bibitem{Mookiah2013_EA_Tuning}
M.~Mookiah, U.~Acharya, R.~Martis, C.~Chua, C.~Lim, E.~Ng, A.~Laude,
  Evolutionary algorithm based classifier parameter tuning for automatic
  diabetic retinopathy grading: A hybrid feature extraction approach, Knowl
  Based Syst 39 (2013) 9--22.

\bibitem{Shen2016_FFly_Tuning}
L.~Shen, H.~Chen, Z.~Yu, W.~Kang, B.~Zhang, H.~Li, B.~Yang, D.~Liu, Evolving
  support vector machines using fruit fly optimization for medical data
  classification, Knowledge-Based Systems 96 (2016) 61--75.
