...
% you are right... but the way the reviewer has expressed it is quite strange.
...
% well, no previous work on "print run & book sales prediction" has been done (at least, I have not found anything in the bibliography)
