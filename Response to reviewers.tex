...
\end{verbatim}
% Antonio - TODO: we have also to link them properly to the new section and to remove them from the text describing Section 4 where they were... Then, say this in the response.
% I have linked them, but I think we should leave that sentence in Section 4 refering to the methods we have used.
